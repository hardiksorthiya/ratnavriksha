<section class="about-mission py-5">
    <div class="container">
        <div class="about-mission-header text-center">
            <span class="about-who-label">Our Foundation</span>
            <h2 class="about-who-title font-pilo">Mission, Vision &amp; Values</h2>
        ...
        <div class="row g-4 g-lg-5">
            <div class="col-md-4">
                <div class="about-mission-card h-100">
                    <div class="about-mission-card-icon" aria-hidden="true">
