...
@section('page_heading', 'Product Enquiries')

@section('content')
    <div class="dash-card mb-4">
        <h2 class="dash-title mb-1">Product Enquiries</h2>
        <p class="dash-subtitle mb-0">Messages submitted from product detail pages</p>
    </div>
                    ...
                    <tbody>
                        @forelse ($enquiries as $enquiry)
                            <tr>
                                ...
                                <td>{{ $enquiry->product?->name ?? $enquiry->product_name ?? '—' }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center py-5 text-muted-small">No product enquiries yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
